import { pgTable, text, serial, timestamp, integer, jsonb, doublePrecision, uniqueIndex } from "drizzle-orm/pg-core";
 ...
 */
export const branchAuditsTable = pgTable(
  "branch_audits",
  {
  ...
  (t) => [
    /** Bir filial (mudir) = bir kunda faqat 1 ta cheklist */
    uniqueIndex("branch_audits_manager_visit_date_uidx").on(t.managerEmployeeId, t.visitDate),
  ],
);
