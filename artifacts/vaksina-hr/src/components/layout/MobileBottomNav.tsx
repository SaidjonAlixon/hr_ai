...
const ROLE_MOBILE_PATHS: Record<string, string[]> = {
  ...
  mentor: ['/dashboard', '/vazifalar', '/davomat-face'],
  department_head: ['/dashboard', '/vazifalar', '/davomat-face', '/employees', '/pharmacy-network'],
  mudir: ['/dashboard', '/vazifalar', '/davomat-face', '/pharmacy-network'],
  koordinator: ['/dashboard', '/vazifalar', '/davomat-face', '/pharmacy-network', '/checklist'],
  ...
  ombor: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  moliya_xodim: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  taminot: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  rivojlantirish: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  mamuriy: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  gpp: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  oshpaz: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  marketing: ['/vazifalar', '/eslatmalar', '/davomat-face'],
  ombor_rahbar: ['/dashboard', '/vazifalar', '/employees', '/davomat-face', '/eslatmalar'],
  moliya_rahbar: ['/dashboard', '/vazifalar', '/oylik', '/employees', '/davomat-face'],
  taminot_rahbar: ['/dashboard', '/vazifalar', '/employees', '/davomat-face', '/eslatmalar'],
  rivojlantirish_rahbar: ['/dashboard', '/vazifalar', '/employees', '/davomat-face', '/eslatmalar'],
  mamuriy_rahbar: ['/dashboard', '/vazifalar', '/employees', '/davomat-face', '/eslatmalar'],
