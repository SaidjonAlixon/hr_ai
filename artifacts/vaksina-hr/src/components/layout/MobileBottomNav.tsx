...
const ROLE_MOBILE_PATHS: Record<string, string[]> = {
  ...
  mudir: ['/dashboard', '/vazifalar', '/reviziya', '/davomat-face', '/boglanish'],
  ...
  ombor: ['/omborxona-ish', '/vazifalar', '/eslatmalar', '/davomat-face'],
  ...
  ombor_rahbar: ['/dashboard', '/omborxona-ish', '/vazifalar', '/employees', '/davomat-face'],
